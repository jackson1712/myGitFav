...
export class Favorites {
    ...
    delete(user) {
        ...
        .filter(entry =>entry.login.toUpperCase() !== user.login.toUpperCase())
...
export class FavoritesView extends Favorites {
    ...
    createRow() {
        ...
        tr.innerHTML = ` 
        <td class="user">
            <img src="https://github.com/jackson1712.png" 
            alt="Imagem de jackson1712" >
            <a href="https://github.com/jackson1712" 
            target="_blank">
                <p>Jackson Moura</p>
                <span>/jackson1712</span>
            </a>
        </td>
